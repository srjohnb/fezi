...
export interface TanStackEndpoint<TInput, TOutput> extends Endpoint<TInput, TOutput> {
   ...
   */
  queryOptions: <TQueryKey extends QueryKey = QueryKey>(
...
// Re-export FeziRouterDefinition for convenience if needed by adapter users
export type { FeziRouterDefinition };
