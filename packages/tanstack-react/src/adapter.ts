...
function asTanStackEndpoint<TInput, TOutput>(
  ...
  const asTanStackEndpoint = { ...endpoint } as TanStackEndpoint<TInput, TOutput>;

  asTanStackEndpoint.queryOptions = function <
  ...
  asTanStackEndpoint.mutationOptions = function <TContext = unknown>(
  ...
  asTanStackEndpoint.getKey = (params?: Record<string, any>): QueryKey => {
