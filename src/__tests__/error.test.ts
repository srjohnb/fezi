...
import { ZimFetchError } from '../lib/types';

describe('ZimFetchError', () => {
  it('should create an error with the correct properties', () => {
    ...
    // Execute
    const error = new ZimFetchError(message, url, options);

    // Assert
    expect(error).toBeInstanceOf(Error);
    expect(error).toBeInstanceOf(ZimFetchError);
    expect(error.message).toBe(message);
    expect(error.name).toBe('ZimFetchError');
  ...
  it('should include response properties if provided', () => {
    ...
    // Execute
    const error = new ZimFetchError(message, url, options, response);
  ...
  it('should include data if provided', () => {
    ...
    // Execute
    const error = new ZimFetchError(message, url, options, undefined, data);
  ...
  it('should include both response and data if provided', () => {
    ...
    // Execute
    const error = new ZimFetchError(message, url, options, response, data);
